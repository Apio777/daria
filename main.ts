controller.right.onEvent(ControllerButtonEvent.Pressed, function () {
    story.spriteSayText(mySprite, "Esta autopista es muy larga....")
})
let mySprite: Sprite = null
game.splash("Pulsa \"A\" Para empezar tu aventura!!")
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
mySprite = sprites.create(assets.image`DARA`, SpriteKind.Player)
let dogi = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
[img`
    ...
    f f f f d d d f d f f f 
    f f d d d d d f d f f . 
    f f d d d d d d d f . . 
    7 4 7 7 7 d d d f f . . 
    7 4 4 4 7 9 9 9 9 f . . 
    7 7 7 7 d 1 1 1 1 f . . 
    7 7 d d d 4 4 4 4 f f . 
    . d d d d f f f f f f . 
    . . f f . . . f f f . . 
    `,img`
    . . . . f f f f f . . . 
